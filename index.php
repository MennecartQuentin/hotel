...
<body style="margin-top:50px;">
    ...
    <!--Infos sur la chambre Commence ici-->

    <div class="container-fluid" id="red">
        <div class="container text-center">
            <h1>Bienvenue à
                <font color="#a6e22b;"><b> l'hôtel Hypnos</b></font>
            </h1>
            <hr><br>
            <div class="row">
                <div class="hov">
	...
	?>
                        <div class="col-sm-4">
                            ...
                            <h4 class="Room_Text">[
                                <?php echo $r_res['type']; ?>]</h4>
                            <p class="text-justify">
                                <?php echo substr($r_res['details'],0,100); ?>
                            </p><br>
