...
if(isset($savedata))
{
  ...
  '$room_type','$Occupancy','$cdate','$ctime','$codate')";
   ...
   {
   $msg= "<h1 style='color:blue'>Vous avez réservé cette chambre avec succès</h1><h2><a href='détails de réservation.html'>View </a></h2>"; 
   }
  }
}
?>
                  ...
                  <option>Chambre twin de luxe</option>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <div class="row">
                                <div class="control-label col-sm-5">
                                    <h4>Vérifier la date d'entrée :</h4>
                                </div>
                                <div class="col-sm-7">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <div class="row">
                                <div class="control-label col-sm-5">
                                    <h4>Vérifier le temps d'entrée :</h4>
                                </div>
                                <div class="col-sm-7">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <div class="row">
                                <div class="control-label col-sm-5">
                                    <h4>Vérifier la date de sortie :</h4>
                                </div>
                                <div class="col-sm-7">
