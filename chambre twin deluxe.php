        ...
        <div class="continer">
            <div class="row">
                ...
                <div class="col-sm-7">
                    ...
                    <p class="text-justify">Les chambres à lits jumeaux au design contemporain mais simple sont bien équipées avec des équipements modernes. Décor frais et ambiance raffinée est la combinaison gagnante pour faire de ces chambres un choix idéal pour les voyageurs
                        d'affaires exigeants.
                    </p>
                    <div class="row">
